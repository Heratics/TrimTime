...
function ChangePassword() {
  ...
  return (
    <div className="mt-6 max-w-xl rounded-2xl border bg-white p-6 shadow-sm">
      ...
      {success && (
        <div className="mb-4 rounded-lg border border-green-200 bg-green-50 p-3 text-sm text-green-700">Password changed successfully.</div>
      )}
